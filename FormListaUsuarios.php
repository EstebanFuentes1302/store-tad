							...
							<div class="card flex-fill">
								...
								<table class="table table-hover my-0">
							        ...
							        <tbody style="border: black 2.5px solid;">
										...
										<?php foreach ($LisUsuarios as $User) { if($User["DNI"]==$_SESSION['dniuser']){}else{?>
											...
											<td><?php echo $User["DNI"] ?></td>
												...
												<td><?php echo "****"?></td>
												<td> <?php switch ($User["Rol"]){case 0:echo '<p style="background: #6ff77e ;font-weight: bold";>Administrador<p>';break;
												...
												<td>
													<a href="eliminar_usuario.php?id=<?php echo $User["DNI"] ?>"  class="btn btn-danger" style ="<?php if($_SESSION['RolUser']==1){echo $Estilo; }?>">
